...
class LunarLander(gym.Env, EzPickle):
    ...
    def reset(self, initial_pos=None):
        ...
        if initial_pos is not None:
            x, y = initial_pos
            initial_x = (VIEWPORT_W/SCALE/2) + (VIEWPORT_W/SCALE/2) * x
            initial_y = (self.helipad_y+LEG_DOWN/SCALE) + (VIEWPORT_H/SCALE/2) * y
        else:
            initial_y = VIEWPORT_H/SCALE
            initial_x = np.random.rand() * VIEWPORT_W / SCALE / 2 + VIEWPORT_W / SCALE / 4
