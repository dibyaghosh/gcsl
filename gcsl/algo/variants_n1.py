from gcsl.algo import buffer, networks_n1
...
def default_markov_policy(env, env_params):
    ...
    if env.action_space.n > 100: # Too large to maintain single action for each
        policy_class = networks_n1.IndependentDiscretizedStochasticGoalPolicy
    else:
        policy_class = networks_n1.DiscreteStochasticGoalPolicy_m
    return policy_class(
                env,
