...
def run(output_dir='/tmp', env_name='pointmass_empty', gpu=True, seed=0, **kwargs):
    ...
    exp_prefix = 'opensource_exps/20200609/%s/gcsl/' % (env_name,)
...
if __name__ == "__main__":
    params = {
        'seed': [0, 1, 2],
        'env_name': ['lunar', 'pointmass_empty','pointmass_rooms', 'pusher', 'claw', 'door'],
        'gpu': [False],
    }
    dd_utils.launch(run, params, mode='ec2', instance_type='c4.xlarge')
